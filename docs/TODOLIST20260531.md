...
> **更新 (2026-05-31 晚间)**：
> - F.3 存档架构简化 ✅ 去掉 save_box_pokemon，统一 raw_save_data 读写
> - F.3 拖拽修复 ✅ 同箱Swap用temp变量，跨箱Swap分数组，Save→Bank移动改为 ClearBoxSlot
> - B.1 备份管理 ✅ 5槽位自动备份+手动备份+恢复，卡片展示宝可梦数量/训练家/游玩时间/版本
> - B.2 精灵图标修复 ✅ antd Image → 原生 img 标签
> - E.3 备份UI ✅ 存档编辑底部备份列表
